    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="col-sm-6 d-flex align-items-center">
                ...
                <h1 class="m-0 ms-2">Kampas Rem</h1>
            </div>
            <div class="row mt-2 mb-1">
                <div class="col-sm-6 text-end">
                    <a href="{{ route('rem.create') }}" class="btn btn-primary">
                        + Add Product
                    </a>
                </div>
            </div>
                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('rem.edit', $product->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('rem.destroy', $product->id) }}" method="POST" id="delete-form-{{ $product->id }}">
                                        @csrf
                                        @method('DELETE')
