...
class RemController extends Controller
{
    ...
    {
        $rem = RemModel::All();
        return view('stok/rem', compact('rem'));
    }

    public function create()
    {
        return view('stok/rem_create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rem')->with('success', 'Product added successfully!');
    }


    public function edit($id)
    {
        $rem = RemModel::findOrFail($id);
        return view('stok/rem_edit', compact('rem'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            if ($rem->foto && file_exists(public_path('assets/foto/' . $rem->foto))) {
                unlink(public_path('assets/foto/' . $rem->foto));
            }
        ...
        return redirect()->route('rem')->with('success', 'Oli berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('rem')->with('success', 'Oli berhasil dihapus');
    }
}
